...
public class tables {
    public static void main(String[] args){
      Connection con =null;
      //Statement: excutes the sql queries against database
      Statement st = null;
      try{
       ...
       // st.executeUpdate("insert into appuser (userRole,name,mobileNumber,email,password,address,status) values('SuperAdmin','Rutuja Shirsat','1234567890','shirsatrutuja2002@gmail.com','Rutuja@123','India','Active')");
